...
export class ApiService {
  ...
  getCharacters(): Promise<Character[]> {
    return this.httpClient.get<Character[]>(`${this.urlMarvel}characters?${this.paramsMarvel}`).toPromise().then(
      result => {
        if (result['code'] == 200) {
          if (result['data']['count'] > 0) {
  ...
  getSeries(): Promise<Serie[]> {
    return this.httpClient.get<Serie[]>(`${this.urlMarvel}series?${this.paramsMarvel}`).toPromise().then(
      result => {
        if (result['code'] == 200) {
          if (result['data']['count'] > 0) {
  ...
  getCreators(): Promise<Creator[]> {
    return this.httpClient.get<Creator[]>(`${this.urlMarvel}creators?${this.paramsMarvel}`).toPromise().then(
      result => {
        if (result['code'] == 200) {
          if (result['data']['count'] > 0) {
  ...
  getStories(): Promise<Storie[]> {
    return this.httpClient.get<Storie[]>(`${this.urlMarvel}stories?${this.paramsMarvel}`).toPromise().then(
      result => {
        if (result['code'] == 200) {
          if (result['data']['count'] > 0) {
  ...
  getEvents(): Promise<Event[]> {
    return this.httpClient.get<Event[]>(`${this.urlMarvel}events?${this.paramsMarvel}`).toPromise().then(
      result => {
        if (result['code'] == 200) {
          if (result['data']['count'] > 0) {
